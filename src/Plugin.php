...
namespace Psalm\CodeceptionPlugin;

use Psalm\CodeceptionPlugin\ReturnTypeProvider\StubReturnTypeProvider;
...
class Plugin implements PluginEntryPointInterface
{
    ...
    public function __invoke(RegistrationInterface $psalm, ?SimpleXMLElement $config = null)
    {
        ...
        require_once __DIR__ . '/ReturnTypeProvider/StubReturnTypeProvider.php';
        $psalm->registerHooksFromClass(StubReturnTypeProvider::class);
    }
}
